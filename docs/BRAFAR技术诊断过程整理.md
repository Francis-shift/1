...
| 字段 | 含义 | 在分级反馈里的用途 |
|---|---|---|
| error_class | 错误类别 | 各档位点明"错在哪一类" |
| fault_region | 出错的粗粒度区域(复合块级) | 新手档只给"在哪一带",让其自己缩小范围 |
| fault_line | 出错行(语句级) | 进阶档指行号、熟练档定位补丁 |
| diagnosis | 详细诊断 | 进阶档讲清"为什么错" |
| min_fix_hint | 最小修复提示 | 进阶档给方向、熟练档给改法 |
| concept_hint | 相关概念 | 新手档补基础概念 |
| patched | 修复后代码 | 熟练档直接给最小补丁 |

注意 fault_region 与 fault_line 的关系,就是第 4 节"由粗到细"两个不同深度的
截取:粗粒度(复合块)给新手,细粒度(语句/补丁)给熟练者——定位深度本身
就是个性化的刻度。
